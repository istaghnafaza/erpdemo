...
function buildGuideSheet(): string[][] {
  return [
    ...
    ["• Buat SATU produk dengan satuan stok dasar m³ (bukan SKU terpisah per truk/pikap)"],
    ["• Isi Satuan jual di form Master Barang: Truk / Pikap / Sak + faktor ke m³ + harga"],
    ["• Jual truk langsung ke pelanggan: di POS tandai baris sebagai SO (kirim langsung, stok tidak dipotong)"],
    [""],
